        ...
        <header>
            <nav>
                <div class="row">
                    ...
                    <a class="mobile-nav-icon js--nav-icon"><i class="ion-ios-menu"></i></a>
                </div>
            </nav>
            ...
            <div class="row">
                <form method="post" action="mailer-new.php" class="contact-form">
                    <div class="row">
                        <?php
                        if($_GET('success') == 1) {
                            echo "<div class=\"form-messages success\">Thankyou! your message has been sent.</div>";
                        }
                        if($_GET('success') == 1) {
                            echo "<div class=\"form-messages error\">Something went wrong, plese try again.</div>";
                        }
                        ?>
                    </div>
                    <div class="row">
